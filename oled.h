...
/*********************************************/
extern ROM BYTE g_pucFont[95][6];
/*********************************************/
...
//void oledprintBigNUmber(int numToPrint ,unsigned char page, unsigned char col,int flag, BOOL flag2);
//void oledprintWhiteBigNUmber(int numToPrint ,unsigned char page, unsigned char col,int flag);
//void oledprintBigNUmber(int numToPrint, unsigned char page, unsigned char col, int flag, ...);
